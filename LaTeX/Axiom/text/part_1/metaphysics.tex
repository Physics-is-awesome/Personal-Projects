...
\emph{Existence Exists}, this is by definition an irrefutable point. To negate an argument an antithesis must be supplanted, non-existing, but non-existence by definition implies a existence.
...
a conscious entity. \emph{Cognito, ergo sum}. I think therefore I am. Now upon inspection of this entity it is quite simple, the only capacity it necessarily has is
...
space and time are properties of many things. Extremely important ones. Dimensions to be considered, later an address the geometry and importance of these fundemental dimensions.
...
These thinkers do not need to be human, or even alive for that matter. For future refrences I will refer to it as nous; based upon the greek word.

\subsection{Non-material}
Already defined to be objects that exist(observable have effects) dependent of a thinker.

\section{Assumptions(Axioms)}

Get it, I said the name of the book, Axiom.

Anyways, here I define and summerize the assumptions I have made.

\begin{itemize}
    \item Principle of Causal Order
    \item Time and Spacial symmetry of the laws of nature
    \item Reality Obeys Fundemental Logic and Tautologies
\end{itemize}
Many of the other commonly noted axioms like that the unieverse follows mathematic or that nature is orderly follow naturally from these assumptions.

\section{Platoism and Realism}

With this view of reality, to somewhat conflicting views occur, Platoism and Realism.

Given the view of the surronding reality as `real,' all other principles of Realsim become natural and logical.

From the fact that this view of reality is simply our visiable abstraction of reality based upon logic and mathematics, Platoism becomes natural.
Further analysis of these argumentations have already been presented and will be presented in Essays and this section may latter be updated.

For the purposes of this book, the the equavlency of these expressions will generally be used. With, given the mathematical and abstract nature of this
exersice, Platoism will be used for the majority of the book with equivlent materialistic expressions being used as a translation.
