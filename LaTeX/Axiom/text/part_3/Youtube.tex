...
Here we address the scope of this video. It is meant as an introduction into DG, using an example to help facilitate understanding. For both the purposes of expanding your mind and my own, I have chosen a particularly challenging one I have recently read about.

Taking a self-gravitating fluid and using the structure preserving capacity of DG to preserve positivity, ie that pressure, mass, energy, etc are all positive at all points, and well balanced, ie compressible fluid that admits hydrostatic equilibrium
