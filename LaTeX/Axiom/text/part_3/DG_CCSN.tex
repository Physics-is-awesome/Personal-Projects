...
Running the algorithm is very slow, far slower than anticipated, taking in total # hours to run the solution for first order polynomial, 16 x 16 x 16, 3rd order Runge-Kutta, and Newtonian iteration.
