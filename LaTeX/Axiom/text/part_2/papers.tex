...
\section{Energy conserving and well-balanced discontinuous Galerkin methods for the Euler–Poisson equations in spherical symmetry}

\subsection{Numerical Methods}

Poisson equations is derived to be 
\[
\Phi_h(r) = \Phi_h(r_{j + 1/2}) - \left(\sum^{k+1}_{i=1} \frac{g_{j,i}\tau^{i+1}}{i+1} - \frac{g_{j,-2}}{\tau}   \right) \Big|_{\tau =r}^{r_{j+1/2}}
  \]

  The euler-Poisson equation in DG
