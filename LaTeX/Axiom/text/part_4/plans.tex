...
\begin{itemize}
    \item 1 \colorbox{orange}{Honors ethical theory}
    \item 2 \colorbox{orange}{Honors intro to philosophy}
    \item 3 \colorbox{orange}{Professional Responsibility}
    \item 4 \colorbox{orange}{HR: Western Civilization}
    \item 5 \colorbox{orange}{HR: World civilization}
    \item 6 \colorbox{red}{Intro computer science}
    \item 7 \colorbox{green}{Diff equations 1}
    \item 8 \colorbox{green}{Matrix Algebra}
    \item 9 \colorbox{yellow}{Fundementals in modern physics}
    \item 10 \colorbox{yellow}{mechanics 1}
    \item 11 \colorbox{green Intro to abstract mathematics}
