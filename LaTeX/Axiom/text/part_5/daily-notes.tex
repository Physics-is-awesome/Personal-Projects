...
\section{April 14}
Today has been somewhat successful. What I need to do is focus on simply things that are productive and enjoyable. I will break it into a couple of parts here.

Things I need to do:
\begin{itemize}
  \item School work
  \item Fall Fellowship
\end{itemize}
Simple projects
\begin{itemize}
  \item LaTeX sty file to make writing easier
  \item Abbreviation in emacs to make writing easier
\end{itemize}
Reading/videos
\begin{itemize}
  \item Bible
  \item Relativistic Quantum Field Theory
  \item Numerical Hamiltonian Problems
  \item Handbook on the Philosophy of physics
  \item Advanced GR by Wandu
\end{itemize}
