...
\end{enumerate}
\subsection{Goals for the first three weeks}
\begin{enumerate}
\item Talk to Dr. Mezz
\item Create LaTeX libraries for class
  \item Organize schedule template
\end{enumerate}
as for organizations I am interested in
\begin{enumerate}
\item Society of Physics Students()
\item Book to build
\item Students for Philanthropy
\item Academic quizbowl
\item Alpha Omega Campus Ministry
\item American Nuclear Society
\item Canoe and Hiking club()
\item Christian Student Fellowship
\item Christian Volunteers()
\item Climbing club()
\item Cycling club
\item Data science
\item Forum on science, ethics, and policy
\item Hema at UT
\item Nuclear Managment
\item Martial Arts club
\item Model UN
\item Naturalist club
\item Out in STEM
\item Pickle ball
\item Astronomy
\item Caving
...
I want to walk to and time walk between and time from
\begin{itemize}
  \item Physics
  \item Humanities
  \item Business
  \item Health and Recreation
  \item Recreational fitness
  \item Rocky top dining
  \item Stokely Hall
  \item Volenteer Hall
\end{itemize}

I would also like to explore the library, Weslyan house,

I want to try biking around the area

I am required to go to Authoring your story, rocky top road map, and torch night

I would consider going to dining scavenger hunt and brunch

I will work on my schedule to come up with something more detailed to my current model.
\section{*Grad}
