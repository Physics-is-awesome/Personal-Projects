...
for obs_name, eq in evol_eqs.items():
    ...
    with open(file_path, 'w') as f:
        ...
        f.write("contains\n")
        f.write(f"  subroutine compute_{obs_name}(phi_m_i, phi_rho_i, phi_sigma_i, u_h, T_h, dT_h_dx, sigma_h, eta_h, deta_h_dx, rho_h, dphi_m_dx, dphi_m_i, du_h_dx, F_{obs_name})\n")
        f.write("    implicit none\n")
        f.write("    ! Declare inputs and outputs as real\n")
        f.write("    real, intent(in) :: phi_m_i, phi_rho_i, phi_sigma_i, u_h, T_h, dT_h_dx, sigma_h, eta_h, deta_h_dx, rho_h, dphi_m_dx, dphi_m_i, du_h_dx\n")
