...
for obs_name, eq in evol_eqs.items():
    ...
    with open(file_path, 'w') as f:
        ...
        f.write("    integer, intent(in) :: Re\n")
        f.write("    real(8), intent(in) :: m_h, phi_m_i, phi_rho_i, phi_sigma_i, u_h, T_h, dT_h_dx, sigma_h, eta_h, deta_h_dx, rho_h, dphi_m_dx, dphi_m_i, du_h_dx\n")
        f.write(f"    real(8), intent(out) :: F_{obs_name}\n")
        f.write("\n")
